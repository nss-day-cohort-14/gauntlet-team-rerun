...
},{"../src/weapon":20}],5:[function(require,module,exports){
'use strict';

const GrandWeapon = {};
GrandWeapon.BlasterFromThePast = require('../src/weaponBlaster');
GrandWeapon.BoozeOoka = require('../src/weaponBooze');
GrandWeapon.Dagger = require('../src/weaponDagger');
GrandWeapon.Hammer = require('../src/weaponHammer');
GrandWeapon.InsultBarrage = require('../src/weaponInsultBarrage');
GrandWeapon.Leer = require('../src/weaponLeer');
GrandWeapon.MemoryBomb = require('../src/weaponMemoryBomb');
GrandWeapon.MumbleBee = require('../src/weaponMumble');
GrandWeapon.RacistComment = require('../src/weaponRacist');
GrandWeapon.UltraSigh = require('../src/weaponSigh');
GrandWeapon.TheSnort = require('../src/weaponSnort');
GrandWeapon.YawnZilla = require('../src/weaponYawn');

module.exports = GrandWeapon;
},{"../src/weaponBlaster":21,"../src/weaponBooze":22,"../src/weaponDagger":23,"../src/weaponHammer":24,"../src/weaponInsultBarrage":25,"../src/weaponLeer":26,"../src/weaponMemoryBomb":27,"../src/weaponMumble":28,"../src/weaponRacist":29,"../src/weaponSigh":30,"../src/weaponSnort":31,"../src/weaponYawn":32}],6:[function(require,module,exports){
'use strict';
...
},{"../src/drunkGrandpa":11,"../src/grandpa":13,"../src/meanGrandpa":16,"../src/person":17,"../src/smartGrandpa":18}],7:[function(require,module,exports){
'use strict';
...
},{"../src/FamWeapon":4,"../src/person":17}],9:[function(require,module,exports){
'use strict';
...
},{"../src/FamWeapon":4,"../src/person":17}],10:[function(require,module,exports){
'use strict';
...
},{"../src/FamWeapon":4,"../src/person":17}],11:[function(require,module,exports){
"use strict";
...
},{"../src/GrandWeapon":5,"../src/grandpa":13}],12:[function(require,module,exports){
'use strict';
...
},{"../src/brother":8,"../src/daughter":9,"../src/daughter_in_law":10,"../src/grandson":14,"../src/person":17,"../src/son":19,"../src/wife":33}],13:[function(require,module,exports){
"use strict";
...
module.exports = Grandpa;
},{"../src/person":17}],14:[function(require,module,exports){
'use strict';
...
},{"../src/FamWeapon":4,"../src/person":17}],15:[function(require,module,exports){
'use strict'; 
...
},{"../src/GrandpaType":6,"../src/argument":7,"../src/family":12,"../views/aboutUs.jade":34,"../views/battle.jade":35,"../views/buildScreen.jade":36,"../views/fightResults.jade":37,"../views/gVictoryView.jade":38,"../views/header.jade":39,"../views/rules.jade":40,"../views/victoryView.jade":41,"jQuery":2}],16:[function(require,module,exports){
"use strict";
...
},{"../src/GrandWeapon":5,"../src/grandpa":13}],17:[function(require,module,exports){
'use strict';
...
},{"../src/GrandWeapon":5,"../src/grandpa":13}],19:[function(require,module,exports){
'use strict';
...
module.exports = Son;
},{"../src/FamWeapon":4,"../src/person":17}],20:[function(require,module,exports){
'use strict';
...
},{"../src/weapon.js":20}],22:[function(require,module,exports){
"use strict";
...
},{"../src/weapon.js":20}],23:[function(require,module,exports){
"use strict";
...
},{"../src/weapon.js":20}],24:[function(require,module,exports){
"use strict";
...
},{"../src/weapon.js":20}],25:[function(require,module,exports){
"use strict";
...
},{"../src/weapon.js":20}],26:[function(require,module,exports){
"use strict";
...
},{"../src/weapon.js":20}],27:[function(require,module,exports){
"use strict";
...
},{"../src/weapon.js":20}],28:[function(require,module,exports){
"use strict";
...
},{"../src/weapon.js":20}],29:[function(require,module,exports){
"use strict";
...
},{"../src/weapon.js":20}],30:[function(require,module,exports){
"use strict";
...
},{"../src/weapon.js":20}],31:[function(require,module,exports){
"use strict";
...
},{"../src/weapon.js":20}],32:[function(require,module,exports){
"use strict";
...
},{"../src/weapon.js":20}],33:[function(require,module,exports){
'use strict';
...
module.exports = Wife;
},{"../src/FamWeapon":4,"../src/person":17}],34:[function(require,module,exports){
...
buf.push("<div class=\"jumbotron aboutUs\"><p class=\"aboutUs--content arapey\"> Dave Harms, Alex Horton, and Jamey McAuliffe have been working on this project for somewhere between 4 days to 2 years. Perhaps this sort of family conflict game is a cathartic experience… or just a class requirement? We’ll never know!</p></div>");;return buf.join("");
};
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (fImage, fName, fStory, gImage, gStory) {
buf.push("<div class=\"fightScreen arapey\"><div><button id=\"fight\" class=\"btn btn-default fight--button\">Fight!</button></div><div class=\"row choose--div\"><div class=\"col-xs-6\"><h2>Grandpa</h2><img" + (jade.attr("src", gImage, true, false)) + "/></div><div class=\"col-xs-6\"><h2>" + (jade.escape(null == (jade_interp = fName) ? "" : jade_interp)) + "</h2><img" + (jade.attr("src", fImage, true, false)) + "/></div></div><div class=\"results\"><div class=\"row backStory\"><div class=\"col-xs-6 fight--grandpa\"><p class=\"story\">" + (jade.escape(null == (jade_interp = gStory) ? "" : jade_interp)) + "</p></div><div class=\"col-xs-6 fight--family\"><p class=\"story\">" + (jade.escape(null == (jade_interp = fStory) ? "" : jade_interp)) + "</p></div></div></div></div>");}.call(this,"fImage" in locals_for_with?locals_for_with.fImage:typeof fImage!=="undefined"?fImage:undefined,"fName" in locals_for_with?locals_for_with.fName:typeof fName!=="undefined"?fName:undefined,"fStory" in locals_for_with?locals_for_with.fStory:typeof fStory!=="undefined"?fStory:undefined,"gImage" in locals_for_with?locals_for_with.gImage:typeof gImage!=="undefined"?gImage:undefined,"gStory" in locals_for_with?locals_for_with.gStory:typeof gStory!=="undefined"?gStory:undefined));;return buf.join("");
};
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (family, message, undefined) {
buf.push("<div class=\"buildScreen arapey\"><div class=\"choose--div\"><h2>" + (jade.escape(null == (jade_interp = message) ? "" : jade_interp)) + "</h2><label for=\"choose\">Choose Family Member</label><select id=\"choose\" name=\"famMember\" class=\"choose--select\">");
// iterate family
;(function(){
  var $$obj = family;
...
buf.push("<option" + (jade.attr("value", index, true, false)) + ">" + (jade.escape(null == (jade_interp = val) ? "" : jade_interp)) + "</option>");
    }
...
buf.push("</select><button id=\"choose-btn\" class=\"btn choose--button\">Pick A Winner!</button></div></div>");}.call(this,"family" in locals_for_with?locals_for_with.family:typeof family!=="undefined"?family:undefined,"message" in locals_for_with?locals_for_with.message:typeof message!=="undefined"?message:undefined,"undefined" in locals_for_with?locals_for_with.undefined:typeof undefined!=="undefined"?undefined:undefined));;return buf.join("");
};
},{"jade/runtime":3}],37:[function(require,module,exports){
var jade = require("jade/runtime");
...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (familyMember, results) {
buf.push("<div class=\"row fight--container arapey\"><div class=\"col-xs-6 fight--grandpa\"><p class=\"weap\">" + (jade.escape(null == (jade_interp = 'Grandpa attacks with ' + results.gweap + '!') ? "" : jade_interp)) + "</p><p class=\"remark\">" + (jade.escape(null == (jade_interp = '"'+ results.gremark + '."') ? "" : jade_interp)) + "</p><p class=\"damage\">" + (jade.escape(null == (jade_interp = 'Remaining health: ' + results.ghealth) ? "" : jade_interp)) + "</p></div><div class=\"col-xs-6 fight--family\"><p class=\"weap\">" + (jade.escape(null == (jade_interp = familyMember + ' attacks with ' + results.famweap + '!') ? "" : jade_interp)) + "</p><p class=\"remark\">" + (jade.escape(null == (jade_interp = '"'+ results.famremark + '."') ? "" : jade_interp)) + "</p><p class=\"damage\">" + (jade.escape(null == (jade_interp = 'Remaining health: ' + results.fhealth) ? "" : jade_interp)) + "</p></div></div>");}.call(this,"familyMember" in locals_for_with?locals_for_with.familyMember:typeof familyMember!=="undefined"?familyMember:undefined,"results" in locals_for_with?locals_for_with.results:typeof results!=="undefined"?results:undefined));;return buf.join("");
};
},{"jade/runtime":3}],38:[function(require,module,exports){
var jade = require("jade/runtime");
...
buf.push("<div class=\"victoryScreen victory\"><h1 class=\"arapey\">Grandpa Wins, I mean I really really Win!</h1><p class=\"arapey\">Grandpa celebrates this hyuge victory.</p><p class=\"arapey\">I win so much.</p><p class=\"arapey\">I get tired of winning</p><p class=\"arapey\">(Grandpa passes out)</p></div>");;return buf.join("");
};
},{"jade/runtime":3}],39:[function(require,module,exports){
var jade = require("jade/runtime");
...
buf.push("<div class=\"row header didone\"><h1>Family Feud</h1><nav class=\"navbar navbar-default\"><ul class=\"list-inline\"><li id=\"rules\" class=\"link\"> <a href=\"#\"><div class=\"link--div active\">Rules</div></a></li><li id=\"start\" class=\"link\"> <a href=\"#\"><div class=\"link--div\">Start Game</div></a></li><li id=\"about\" class=\"link\"> <a href=\"#\"><div class=\"link--div\">About Us</div></a></li></ul></nav></div>");;return buf.join("");
};
},{"jade/runtime":3}],40:[function(require,module,exports){
var jade = require("jade/runtime");
...
buf.push("<div class=\"jumbotron rules\"><p class=\"rules--content arapey\"> Family is everything, and everything includes combat. The Johnson Family has reached Christmas dinner without any major incidents, but finally, things have come to a head. Grandpa has been been increasingly hard to ignore, as his side-comments and general rudeness have put a real strain on the Christmas celebrations. The rest of the family has thrown down the proverbial gauntlet, and now it’s time for battle. </p><p class=\"rules--content arapey\"> You get to choose a family member to fight Grandpa, but even though he’s old, he won’t go down without a whiskey-fueled fight! If beats one family member, you’ve got five others to choose from. There’s nothing that says ‘Christmas in America’ like a Battle Royale!</p><p class=\"rules--content arapey\"> Merry Christmas to all, and to all a GOOD FIGHT.</p></div>");;return buf.join("");
};
},{"jade/runtime":3}],41:[function(require,module,exports){
var jade = require("jade/runtime");
...
buf.push("<div class=\"victoryScreen victory\"><h1 class=\"arapey\">Victory</h1><p>You have defeated Grandpa.</p><p>The family is victorious.</p><p>All is right with the world.</p></div>");;return buf.join("");
};
},{"jade/runtime":3}]},{},[15])
